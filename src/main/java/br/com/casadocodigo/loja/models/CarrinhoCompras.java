...
@Named // permite que o jsf acesse a classe CarrinhoCompras diretamente ao inves de acessar primeiro CarrinhoComprasBean
@SessionScoped
public class CarrinhoCompras implements Serializable {
    ...
    public List<CarrinhoItem> getItens() {
        return new ArrayList<CarrinhoItem>(itens);//dessa forma o arrayList consegue iterar mesmo sendo um Set
    }
